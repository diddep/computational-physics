...
ax_dist[0].plot(rvec, rho(rvec, 27/16), color='r', linestyle='--',label= r'$\rho $ optimized', linewidth=7)
ax_dist[0].plot(rvec, rho(rvec, 2), color='k', linestyle=':',label=r'$\rho $ unscreened', linewidth=7)
...
ax_dist[1].plot(rvec, rho(rvec, 27/16), color='r', linestyle='--', label=r'$\rho $ optimized', linewidth=7)
ax_dist[1].plot(rvec, rho(rvec, 2), color='k', linestyle=':', label=r'$\rho $ unscreened', linewidth=7)
