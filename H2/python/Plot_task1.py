...
ax_dist[0].set_title(r'Distribution for $\mathcal{R}_1 $', fontsize=15)
ax_dist[0].set_xlabel(r"Radius [$a_0 $]", fontsize=15)
ax_dist[0].set_ylabel("Density", fontsize=15)
...
ax_dist[1].set_ylabel("Density", fontsize=15)
ax_dist[1].set_title(r'Distribution for $\mathcal{R}_2 $', fontsize=15)
ax_dist[1].legend()
plt.tight_layout()
...
ax_theta[0].set_ylabel('Density', fontsize=15)
ax_theta[0].legend()
...
ax_theta[1].set_ylabel('Density', fontsize=15)
plt.tight_layout()
