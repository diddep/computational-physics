...
arr_r1 = np.sqrt(np.sum(arr_R1, axis=1)**2)
arr_r2 = np.sqrt(np.sum(arr_R2, axis=1)**2)
print(arr_r1)
...
counts_r1, bins_r1 = np.histogram(arr_r1, bins = 100, density = True)
counts_r2, bins_r2 = np.histogram(arr_r2, bins = 100, density = True)
