...
array = np.genfromtxt('../csv/position_track.csv', delimiter=',')#.reshape(-1,7)
...
yax.plot(t, q1x, label='q1')
yax.plot(t, q2x, label='q2')
yax.plot(t, q3x, label='q3')
...
zax.plot(t, q1x, label='q1')
zax.plot(t, q2x, label='q2')
zax.plot(t, q3x, label='q3')
