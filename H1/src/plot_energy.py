...
plt.tight_layout()
plt.savefig(f'../Energy_plots/plot_energy_dt{dt}.png')
...
plt.legend(fontsize=10)
plt.tight_layout()
plt.savefig(f'../Energy_plots/plot_P_dt{dt}.png')
...
axP.set_title(f'Temperature over time with timestep dt={dt}', fontsize = 15)
plt.legend(fontsize=10)
plt.tight_layout()
plt.savefig(f'../Energy_plots/plot_T_dt{dt}.png')
#plt.show()
