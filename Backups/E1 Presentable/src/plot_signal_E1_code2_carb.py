...
pos_array = np.genfromtxt('../task1_5/All_three_particles/Saved_trajectory_carb_small_dt.csv', delimiter=',', skip_header=0)
vel_array = np.genfromtxt('../task1_5/All_three_particles/Saved_velocity_carb_small_dt.csv', delimiter=',', skip_header=0)
